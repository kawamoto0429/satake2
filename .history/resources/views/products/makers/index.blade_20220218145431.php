...
<div class="container">
    ...
    <div class="maker-container">
        ...
        <form method="POST" action="/products/makers" enctype="multipart/form-data" name="fome">
            {{ csrf_field() }}
            <div class="col-sm-8 input-group mb-3">
                <input type="text" name="name" value="{{old('name')}}" maxlength="10" onKeyUp="limit(10)" id="a">
                <input type="file" name="imgpath">
                <button class="c_btn" type="submit" >Create</button>
            </div>
                @error('name')
