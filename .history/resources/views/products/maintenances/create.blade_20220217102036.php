    ...
    <div>
        <form method="POST" action="{{ route('maintenance.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="name" value="{{old('name')}}" class="form-control" maxlength="40">
                    @error('name')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_1pc" value="{{old('price_1pc')}}" class="form-control" maxlength="40">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_10pcs" value="{{old('price_10pcs')}}" class="form-control" maxlength="40">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_30pcs" value="{{old('price_30pcs')}}" class="form-control" maxlength="40">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select name="maker_id" id="maker" value="{{old("maker_id")}}" class="form-control" maxlength="40">
