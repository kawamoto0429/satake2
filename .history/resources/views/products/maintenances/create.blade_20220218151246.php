    ...
    <div>
        <form method="POST" action="{{ route('maintenance.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="number" name="price_1pc" value="{{old('price_1pc')}}" class="form-control a" maxlength="40" min=1 onKeyUp="limit(15)">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="number" name="price_10pcs" value="{{old('price_10pcs')}}" class="form-control a" maxlength="40" min=1 onKeyUp="limit(15)">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="number" name="price_30pcs" value="{{old('price_30pcs')}}" class="form-control" maxlength="40" min=1 onKeyUp="limit(15)">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="jan" value="{{old("jan")}}" class="form-control a" maxlength="40" onKeyUp="limit(15)">
