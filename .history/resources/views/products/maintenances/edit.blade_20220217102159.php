    ...
    <div>
        ...
        <form method="POST" action="{{ route('maintenance.update', $maintenance)}}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="name" value={{ $maintenance->name }} class="form-control" maxlength="40">
                    @error('name')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_1pc" value="{{$maintenance->price_1pc}}" class="form-control" maxlength="40">
                    @error('price_1pc')
                    <div class="error">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_10pcs" value={{$maintenance->price_10pcs}} class="form-control" maxlength="40">
                    @error('price_10pcs')
                    <div class="error">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="price_30pcs" value={{$maintenance->price_30pcs}} class="form-control" maxlength="40">
                    @error('price_30pcs')
                    <div class="error">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="jan" value={{$maintenance->jan}} class="form-control" maxlength="40">
                </div>
                    @error('jan')
                    <div class="error">{{$message}}</div>
                    @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="lot" value="{{$maintenance->lot}}" class="form-control" maxlength="40">
                    @error('lot')
                    <div class="error">{{$message}}</div>
                    @enderror
                </div>
