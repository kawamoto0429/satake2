...
class OrderController extends Controller
{
    ...
    public function purchase()
    {
        ...
        $purchases = Purchase::whereDate('created_at', $today)->whrere('user_id', $user_id)->paginate(20);
        $counting = [];

        foreach ($categories as $category)
        {
            $counting[$category->name] = count(Purchase::where('category_name', $category->name )->whereDate('created_at', $today)->whrere('user_id', $user_id)->get());
        }
